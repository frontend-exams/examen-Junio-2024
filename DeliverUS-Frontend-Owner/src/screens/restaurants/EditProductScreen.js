    ...
    async function fetchProductDetail () {
      try {
        ...
        if (initialValues.visibleUntil && typeof initialValues.visibleUntil === 'string') {
          initialValues.visibleUntil = initialValues.visibleUntil.split('T')[0] // El split divide la fecha larga por la T sin incluirla y nos quedamos con el primer elemento de la división que es la fecha correcta como la queremos
          // '2025-09-23T00:00:00.000Z' ==> ['2025-09-23', '00:00:00.000Z']
        }
