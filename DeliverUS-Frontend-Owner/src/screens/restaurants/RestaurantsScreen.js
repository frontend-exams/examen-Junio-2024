  ...
  const renderRestaurant = ({ item }) => {
    return (
      ...
      >
        ...
        {item.percentage < 0
          ? (
          <TextRegular style={{ color: GlobalStyles.brandSuccess }}>¡Descuento aplicado!</TextRegular>
            )
          : item.percentage > 0
            ? (
          <TextRegular style={{ color: GlobalStyles.brandPrimary }}>¡Incremento de precios aplicado!</TextRegular>
              )
            : null
          }
